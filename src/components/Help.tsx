    ...
    items: [
      {
        ...
        body: (
          <>
            <p>▶で再生、倍速は×1〜×300。⏭は1約定ずつ進めるコマ送りです。「昼休みをスキップ」は昼休みなど売買の無い時間を飛ばします。</p>
      ...
      },
      {
        ...
        body: (
          <>
            ...
            <p>売買の中身は<b>「botの売買」パネル</b>に出ます。botごとに小さな値動きの図があり、<b>建てた値段から返した値段まで1本の線</b>で結ばれます。赤が勝ち、青が負けです。下の一覧には <b>いくらで建てて、いくらで返して、1株あたり何円、合計何円</b> が並びます。</p>
      ...
      },
      {
        ...
        body: (
          <>
            <p>インジケーター・足・再生速度・音・歩み値・対戦の設定は<b>自動で保存されます</b>。次に開いたときは前回のままなので、毎回選び直す必要はありません。</p>
      ...
      },
      {
        ...
        body: (
          <>
            <p>下の「音」ボタンを押すと <b>BGM / 値動き / 約定</b> の3つを別々に切り替えられます。</p>
